...
const Footer = () => {
  return (
    <div>
      <section className="py-12 bg-white rounded-2xl shadow-xl  ring-gray-900/10">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-center xl:flex xl:items-center xl:justify-between xl:text-left">
            <div className="xl:flex xl:items-center xl:justify-start gap-2">
              <Image
              ...
              <ul className="flex items-center justify-center space-x-8 xl:justify-end">
                ...
                <li>
                  <a
                    href="#"
                    title=""
                    className="block dark:text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"
                  >
                    <svg
                      className="w-6 h-6"
                      xmlns="http://www.w3.org/2000/svg"
